...
> **2026-09-15 공개:** [P3 개선본 영상](https://github.com/user-attachments/assets/cdec4e42-c54b-443c-969c-5452c6ed7d70)을 [README](../README.md#2분-데모)에 연결했다. 카레 저장 결과를 설명 종료까지 유지하도록 편집했고 사용자 확인을 마쳤다. 아래는 보존 중인 최초 편집본의 제작 기록이며, 공개본 해시와 후속 검증은 [현재 맥락](00-current-context.md)을 따른다.
...
사용자 영상 확인과 GitHub 첨부 공개·README 연결을 완료했다. 실제 게시 플레이어·모바일 가독성 확인은 후속이다. 실기기 경계 QA·사용자 관찰·OCR 연결은 이번 영상 완성과 구분한다.
