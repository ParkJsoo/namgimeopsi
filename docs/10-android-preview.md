...
- iOS 독립 실행 preview·핵심 QA는 이후 완료했다(`docs/11-ios-preview.md`). 영상 촬영은 남아 있다. iPhone 후속 전문 리뷰의 `e45f128`·`0e49aa6` 공통 코드 수정은 이전 APK(`61b1b87a…`)에 포함되지 않았으며, 해당 최신 수정의 갱신 설치·회귀는 위 `14a7977` 최신 항목에서 완료했다.
