...
const styles = StyleSheet.create({
  ...
  needsReview: { marginTop: 4, color: '#8A5311', fontSize: 12, lineHeight: 17, fontWeight: '700' },
  excludeButton: { minHeight: 44, minWidth: 44, paddingVertical: 8, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#F1EEE7', justifyContent: 'center' },
  ...
  storageOption: { flex: 1, minHeight: 44, paddingHorizontal: 6, paddingVertical: 8, borderRadius: 12, backgroundColor: '#F1EEE7', alignItems: 'center', justifyContent: 'center' },
  storageOptionSelected: { backgroundColor: '#E4F0E7', borderWidth: 1, borderColor: '#2F6B4F' },
  storageText: { textAlign: 'center', color: '#6C7168', fontSize: 12, fontWeight: '600' },
